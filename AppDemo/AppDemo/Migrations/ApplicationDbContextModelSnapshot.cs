...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppDemo.Models.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AppDemo.Models.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AppDemo.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AppDemo.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "1",
                            ConcurrencyStamp = "1877a38b-3262-46b7-bffd-2467b4dca85f",
                            Name = "Admin",
                        ...
                        {
                            Id = "2",
                            ConcurrencyStamp = "0a2e39ec-5ef4-4b44-bb78-06defe0d9050",
                            Name = "Customer",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7c0a6f48-ec8a-4009-be27-6e95f78b7e2d",
                            Email = "admin@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedUserName = "admin@gmail.com",
                            PasswordHash = "AQAAAAEAACcQAAAAENQ0D6odRCs6nEM6UdFLumhYaqNmwf5n7PdQRR62fKpSOLY8F5XIiBlMuABRajT0SA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "706507ac-c88c-4f98-a27a-c56da2c8469d",
                        ...
                        new
                        {
                            Id = "2",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "24fce0f6-23dd-484b-a279-23cfad5b6505",
                            Email = "customer@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedUserName = "customer@gmail.com",
                            PasswordHash = "AQAAAAEAACcQAAAAECvXUqWWiyqOH1epBWEqJgGodUb/oYxFOS0srz+nnENx+AepTs7GhBdy9QAe7mHjsw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "b7cdd203-eb9d-419b-92fc-8350a521e868",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("AppDemo.Models.Book", b =>
                {
                    b.HasOne("AppDemo.Models.Author", "Author")
                        .WithMany("Books")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AppDemo.Models.Category", "Category")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("AppDemo.Models.Order", b =>
                {
                    b.HasOne("AppDemo.Models.Book", "Book")
                        .WithMany("Orders")
